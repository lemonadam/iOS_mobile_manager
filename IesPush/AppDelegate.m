...
//    NSString *token1 = [[NSString alloc] initWithData:deviceToken  encoding:NSUTF8StringEncoding];
//    NSData *token1 = [NSString stringWithUTF8String:[deviceToken bytes]];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"IesPush"];
